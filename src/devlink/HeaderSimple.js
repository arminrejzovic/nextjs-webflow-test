...
export function HeaderSimple({ as: _Component = _Builtin.Block }) {
  return (
    <_Component className="sticky-header is--static" tag="div">
          ...
          >
            <_Builtin.Block className="header-top__wrapper" tag="div">
              <_Builtin.Block className="header-top__left" tag="div">
                <_Builtin.Link
                  className="logo__link events-none"
                  button={false}
                  block="inline"
                  options={{
